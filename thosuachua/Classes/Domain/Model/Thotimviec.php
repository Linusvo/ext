 ...
 * Thotimviec
 */
class Thotimviec extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity {
        /**
         * crdate
         *
         * @var \DateTime
     ...
     * @var string
     */
    protected $tinhthanhpho2 = '';
    /**
     * tinhthanhpho1
     *
     * @var string
     */
    protected $unterkategorie2 = '';
    /**
     * quanhuyen1
     *
     * @var int
 ...
 /**
	...
	/**
	 * Returns the tennhomtho
	 * 
	 * @return string $tennhomtho
	 */
	public function getTennhomtho() {
		return $this->tennhomtho;
	}

	/**
	 * Sets the tennhomtho
	 * 
	 * @param string $tennhomtho
	 * @return void
	 */
	public function setTennhomtho($tennhomtho) {
	...
	/**
	 * Returns the batdauvalue
	 * 
	 * @return string $batdauvalue
	 */
	public function getBatdauvalue() {
		return $this->batdauvalue;
	}

	/**
	 * Sets the batdauvalue
	 * 
	 * @param string $batdauvalue
	 * @return void
	 */
	public function setBatdauvalue($batdauvalue) {
		$this->batdauvalue = $batdauvalue;
	}

	/**
	 * Returns the ketthucvalue
	 * 
	 * @return string $ketthucvalue
	 */
	public function getKetthucvalue() {
		return $this->ketthucvalue;
	}

	/**
	 * Sets the ketthucvalue
	 * 
	 * @param string $ketthucvalue
	 * @return void
	 */
	public function setKetthucvalue($ketthucvalue) {
		$this->ketthucvalue = $ketthucvalue;
	}
    ...
    /**
     * Returns the tinhthanhpho2
     *
     * @return string $unterkategorie2
     */
    public function getUnterkategorie2() {
        return $this->unterkategorie22;
    }

    /**
     * Sets the Unterkategorie2
     *
     * @param string $unterkategorie2
     * @return void
     */
    public function setUnterkategorie2($unterkategorie2) {
        $this->unterkategorie2 = $unterkategorie2;
    }
    /**
     * Returns the tinhthanhpho2
     *
     * @return string $tinhthanhpho2
     */
    public function getTinhthanhpho2() {
        return $this->tinhthanhpho2;
    }

    /**
     * Sets the tinhthanhpho2
     *
     * @param string $tiinhthanhpho2
     * @return void
     */
    public function setTinhthanhpho2($tinhthanhpho2) {
        $this->tinhthanhpho2 = $tinhthanhpho2;
    }
    /**
     * Returns the quanhuyen1
     *
     * @return string $quanhuyen2
     */
    public function getQuanhuyen2() {
        return $this->quanhuyen2;
    }

    /**
     * Sets the quanhuyen1
     *
     * @param string $quanhuyen2
     * @return void
     */
    public function setQuanhuyen2($quanhuyen2) {
        $this->quanhuyen2 = $quanhuyen2;
    }
