...
/**
 * Test case for class \VOV\Thosuachua\Domain\Model\Thotimviec.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class ThotimviecTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \VOV\Thosuachua\Domain\Model\Thotimviec
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = new \VOV\Thosuachua\Domain\Model\Thotimviec();
	}
	 ...
	 * @test
	 */
	public function getTennhomthoReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getTennhomtho()
		);
	}
	 ...
	 * @test
	 */
	public function setTennhomthoForStringSetsTennhomtho() {
		$this->subject->setTennhomtho('Conceived at T3CON10');
	 ...
	 * @test
	 */
	public function getMieutactyReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getMieutacty()
		);
	}
	 ...
	 * @test
	 */
	public function setMieutactyForStringSetsMieutacty() {
		$this->subject->setMieutacty('Conceived at T3CON10');
	 ...
	 * @test
	 */
	public function getBatdauvalueReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getBatdauvalue()
		);
	}
	 ...
	 * @test
	 */
	public function setBatdauvalueForStringSetsBatdauvalue() {
		$this->subject->setBatdauvalue('Conceived at T3CON10');
	 ...
	 * @test
	 */
	public function getKetthucvalueReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getKetthucvalue()
		);
	}
	 ...
	 * @test
	 */
	public function setKetthucvalueForStringSetsKetthucvalue() {
		$this->subject->setKetthucvalue('Conceived at T3CON10');
