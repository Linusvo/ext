...
/**
 * Test case for class \VOV\Thosuachua\Domain\Model\Tintuyendung.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class TintuyendungTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \VOV\Thosuachua\Domain\Model\Tintuyendung
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = new \VOV\Thosuachua\Domain\Model\Tintuyendung();
	}
	 ...
	 * @test
	 */
	public function getTennhatuyendungReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getTennhatuyendung()
		);
	}
	 ...
	 * @test
	 */
	public function setTennhatuyendungForStringSetsTennhatuyendung() {
		$this->subject->setTennhatuyendung('Conceived at T3CON10');
